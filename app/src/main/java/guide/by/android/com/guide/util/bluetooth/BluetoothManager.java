package guide.by.android.com.guide.util.bluetooth;
...
public class BluetoothManager {
	...
	private ArrayList<BluetoothDevice> hidConncetList = new ArrayList<BluetoothDevice>();
     ...
     */
	public void connect(final BluetoothDevice bluetoothDevice,BluetoothProfile.ServiceListener listener) {
		device = bluetoothDevice;
		try {
			BluetoothAdapter.getDefaultAdapter().getProfileProxy(MyApplication.mApplication.getApplicationContext(),
					listener, getInputDeviceHiddenConstant());
		} catch (Exception e) {
